 ...
 */
class Version20171205152816 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus CHANGE fun_fact fun_fact VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci');
